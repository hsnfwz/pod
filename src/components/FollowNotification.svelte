...
<div class="flex flex-col bg-slate-900 p-4 rounded-lg gap-4 w-60 sm:w-80">
  {#if !profile.is_private}
    <div class="flex gap-2 items-center">
      <a class="hover:underline flex items-center gap-2" href={`/u/${profileFollow.sender_profile_id.username}`}>
        <div class="w-8 h-8 rounded-full bg-slate-500"></div>
        <TextBase>{profileFollow.sender_profile_id.username}</TextBase>
