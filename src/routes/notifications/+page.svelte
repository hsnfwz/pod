...
<div class="w-[500px] flex flex-col gap-4">
  <div class="flex bg-slate-900 rounded-lg p-4">
    <a class={`hover:bg-slate-800 rounded-lg px-2 py-1 font-bold self-start ${$page.url.search === '?view=follows' ? 'text-sky-500 pointer-events-none' : ''}`} href="/notifications?view=follows">Follows</a>
    <a class={`hover:bg-slate-800 rounded-lg px-2 py-1 font-bold self-start ${$page.url.search === '?view=shares' ? 'text-sky-500 pointer-events-none' : ''}`} href="/notifications?view=shares">Shares</a>
    <a class={`hover:bg-slate-800 rounded-lg px-2 py-1 font-bold self-start ${$page.url.search === '?view=gifts' ? 'text-sky-500 pointer-events-none' : ''}`} href="/notifications?view=gifts">Gifts</a>
  </div>
